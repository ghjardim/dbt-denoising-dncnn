...
#    noisy_eval_files = glob('./data/test/noisy/*.png')
    noisy_eval_files = glob('./data/test/noisy/*.npy')
...
#    eval_files = glob('./data/test/original/*.png')
    eval_files = glob('./data/test/original/*.npy')
    eval_files = sorted(eval_files)
    start = time.time()
    print(args)
    denoiser.test(eval_files, noisy_eval_files, ckpt_dir=args.ckpt_dir, save_dir='./data/denoised', temporal=0)#args.temporal)
    end = time.time()
